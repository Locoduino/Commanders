...
void setup()
{
	...
	PUSH(buttonsCommander, 0)->AddDccId(15, 0);
	PUSH(buttonsCommander, 0)->AddDccId(15, 1);
	PUSH(buttonsCommander, 0)->AddDccId(16, 0);
	PUSH(buttonsCommander, 0)->AddDccId(16, 1);

	PUSH(buttonsCommander, 0)->Setup(26);

	// Drivers setups

	// Wire leds to mins 7,8,9,10
	...
	GroupState *pAll = new GroupState(15, 0, false);
	pAll->Setup(4,
	...
	GroupState *pNone = new GroupState(15, 1, false);
	pNone->Setup(4,
	...
	GroupState *pAllAndRedFlashing = new GroupState(16, 0, false);
	...
	GroupState *pNoneAndWhiteFlashing = new GroupState(16, 1, false);
