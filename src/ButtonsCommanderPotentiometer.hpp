...
An analog pin of the Arduino will return a value between 0 and ANALOG_LIMIT. The current value of this item
will be mapped from 0/ANALOG_LIMIT to minimum/maximum current value.
...
class ButtonsCommanderPotentiometer : public ButtonsCommanderButton
{
 ...
 public:
	...
	/** Initialize the instance.
	 ...
	 @param inMaximum	maximum value, when the Arduino pin returns value of ANALOG_LIMIT.
	...
	*/
	...
	@param inMaxi	maximum value, when the Arduino pin returns value of ANALOG_LIMIT.
	@param inMoveAccuracy minimum change value to throw a new event.
	*/
