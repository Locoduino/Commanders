...
public:
    ...
    static int GetAddress(int inAddress, int inData);
    static bool IsEnabled(int inData);
...
private:
	...
	static InterruptMonitor			func_InterruptMonitor;
	...
	static unsigned long		  gInterruptMonitorCounter;

	//CFI: debug
	static unsigned long		  gInterruptCounter;
};
